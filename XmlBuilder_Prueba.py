...
<cfdi:Comprobante LugarExpedicion="%(LugarExpedicion)s" metodoDePago="NO IDENTIFICADO"
...
data = {'name':anurag, 'address':MiCasa, 'LugarExpedicion':LugarExpedicion }
archivo=xmlTemplate%data


f =  open("Factura.xml", "wb")
f.write(str(archivo))
f.close()